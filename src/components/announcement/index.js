...
function Announcement() {
    ...
    return (
        <div className=' h-[96%] overflow-x-hidden overflow-y-auto relative'>
            ...
            <div className='mb-4'>
                ...
                <Button variant='outline' className='w-11/12 left-1/2 -translate-x-1/2 absolute bottom-0 ' onClick={downloadFile}>
